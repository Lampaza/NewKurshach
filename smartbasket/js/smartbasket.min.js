			...
			for (let n in s) {
				...
				//функция добавления
					...
					let r = t(this).data("sbId"),
						...
						i = +h.val(),
						o = i * +n;
					n >= 0 ? (o = i * ++n, k.val(n), e.updateBasket(s, r, n, o), e.getSmartBasketMinState(s, "updateSmartBasketMin"), e.commonResult(s, "updateCommonResult")) : n = 1, h.val(i), y.val(+o.toFixed(2)), v.val(n)
